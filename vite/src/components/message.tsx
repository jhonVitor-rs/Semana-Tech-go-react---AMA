...
import { deleteMessageReaction } from "../http/delete-message-reaction";
...
export function Message({
  ...
  if (!roomId) {
    throw new Error("Messages componets must be used within room page");
  }
  ...
  async function removeMessageReactionAction() {
    ...
    try {
      await deleteMessageReaction({ roomId, messageId });
    } catch (error) {
      console.error(error);
